...
<<<<<<< HEAD
        <div class="si grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
            ...
            <div class="col s12 m4  l3 ">
                <a href=#modulo1 class=" scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                    <div >
                        
                        <i class="icons large">
                         <img class="responsive-img ima" src="{{asset('img/icons/dat.png')}}">
                        </i>
            ...
            <div class="col s12 m4 l3 ">
                <a href=#modulo1 class=" scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                    <div >
                        <i class="icons large">
                            <img class="responsive-img ima" src="{{asset('img/icons/alert.png')}}">
                        </i>
            ...
            <div class="col s12 m4 l3 ">
                <a href=#modulo1 class=" scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                    <div >
                        <i class="icons large">
                            <img class="responsive-img ima" src="{{asset('img/icons/cono.png')}}">
                           </i>
            ...
            <div class="col s12 m4 l3 ">
                <a href=#modulo1 class=" scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                    <div >
                        <i class="icons large">
                            <img class="responsive-img ima" src="{{asset('img/icons/coor.png')}}">
                           </i>
