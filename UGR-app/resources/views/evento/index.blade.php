<x-app-layout>
    <div class="degrade">
        <div class="grid-cols-2">
            <!--img class="bg-gray-img" src="{{asset('/img/prueba.jpg')}}"-->
        </div>
                ...
                <div class="p-6 flex space-x-2">
                    ...
                    <div class="flex-1 pl-3">
                        <div class="flex justify-between items-center">
                            <div>
                                <span class="text-gray-800 dark:text-gray-100">{{$evento->user()->name}}</span>
                                <small class="ml-2 text-sm text-gray-600 dark:text-gray-100">{{$evento->created_at}}</small>
                                @unless($evento->created_at->eq($evento->updated_at))
                        ...
                        <p class="mt-3 text-lg text-gray-900 dark:text-gray-100">{{$evento->nombreEvento}}</p>
                        <small class="text-sm text-gray-400 flex mt-3">
                            ...
                            <span class="ml-2">{{$evento->area}}</span>
                        </small>
                    </div>
               
                    @empty
                        <h2 class="text-xl text-black p-4"> no existen eventos </h2>
                    @endforelse
                 </div>
